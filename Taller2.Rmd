...
```
Se observa que el valor del residuo no cambia si se le saca la raiz cúbica a la variable dependiente pero si los valores de $y$.
![](p2c.png)
```{r}
